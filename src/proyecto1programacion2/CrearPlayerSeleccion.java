...
public class CrearPlayerSeleccion extends JFrame implements ActionListener {
     private JTextField usuarioField;
     private JPasswordField passwordField;
     private JButton registrarBtn, regresarBtn;
     private JLabel fondo;

    public CrearPlayerSeleccion() {
        this.setTitle("XIANGQI Registro de Jugador");
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == registrarBtn) {
            ...
            boolean registrado = LogicaGeneral. crearJugadorSeleccion(usuario, password);
